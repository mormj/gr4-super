...
If you run into issues with too much memory being used (or WSL crashing), you can limit parallel compilation across every component by setting `CMAKE_BUILD_PARALLEL_LEVEL=4` before the cmake commands (adjust number based on memory usage).
